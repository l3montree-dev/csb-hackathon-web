  ...
  return (
    <div className="bg-zinc-950">
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
        <h2 className="font-display text-4xl font-medium tracking-tighter text-white">Häufig gestellte Fragen</h2>
        <p className="mt-6 max-w-2xl text-base leading-7 text-gray-300">
        Du hast eine andere Frage und kannst die Antwort nicht finden, die du suchst? Dann{' '}
          <a href="#" target="_blank" rel="noopener noreferrer" className='underline decoration-dashed decoration-1 underline-offset-2 hover:text-l3-200 text-l3-400'>
          schreibe uns gerne eine E-Mail
          </a>.
        </p>
        <p className="mt-6 max-w-2xl text-base leading-7 text-gray-300">Bei allen Veranstaltungen von L3montree gilt unser <a href="https://github.com/l3montree-dev/flawfix/blob/main/CODE_OF_CONDUCT.md" target="_blank" rel="noopener noreferrer" className='underline decoration-dashed decoration-1 underline-offset-2 hover:text-l3-200 text-l3-400'>Code of Conduct</a>.</p>
        <div className="mt-20">
