    ...
    <div className="bg-white py-16 sm:py-24 lg:py-32">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
        <div className="max-w-xl font-display text-4xl font-medium tracking-tighter text-black lg:col-span-7">
          <h2 className="inline sm:block lg:inline xl:block">Du willst auf dem laufenden bleiben?</h2>{' '}
          <p className="inline sm:block lg:inline xl:block">Melde dich für unseren Newsletter an.</p>
        </div>
